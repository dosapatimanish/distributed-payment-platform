package com.paymentplatform.orchestrator.observability;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.paymentplatform.orchestrator..*(..))"
            + " && !within(com.paymentplatform.orchestrator.observability..*)"
            + " && !within(com.paymentplatform.orchestrator.domain..*)"
            + " && !execution(* com.paymentplatform.orchestrator..*Application.*(..))")
