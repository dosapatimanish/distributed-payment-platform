...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.paymentplatform.fxrate..*(..))"
            + " && !within(com.paymentplatform.fxrate.observability..*)"
            + " && !within(com.paymentplatform.fxrate.domain..*)"
            + " && !execution(* com.paymentplatform.fxrate..*Application.*(..))")
