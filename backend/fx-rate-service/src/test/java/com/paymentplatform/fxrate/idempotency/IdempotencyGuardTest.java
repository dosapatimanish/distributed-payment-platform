...
/**
 * Unit test for fx-rate-service's IdempotencyGuard - identical structure to wallet-service's
 * IdempotencyGuardTest (see testing-guide.md), since the two classes are deliberate copies of
 * each other.
 */
@ExtendWith(MockitoExtension.class)
class IdempotencyGuardTest {

    private static final String KEY_PREFIX = "fxrate:idem:";
