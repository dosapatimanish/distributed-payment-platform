...
/**
 * Unit test for ledger-service's IdempotencyGuard - identical structure to the other four
 * services' own IdempotencyGuardTest (see testing-guide.md), since all five classes are
