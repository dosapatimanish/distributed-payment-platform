package com.paymentplatform.merchantpayment.observability;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.paymentplatform.merchantpayment..*(..))"
            + " && !within(com.paymentplatform.merchantpayment.observability..*)"
            + " && !within(com.paymentplatform.merchantpayment.domain..*)"
            + " && !execution(* com.paymentplatform.merchantpayment..*Application.*(..))")
