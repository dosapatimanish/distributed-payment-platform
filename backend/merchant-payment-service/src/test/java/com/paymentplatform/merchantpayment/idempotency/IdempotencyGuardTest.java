...
/**
 * Unit test for merchant-payment-service's IdempotencyGuard - identical structure to the other
 * three services' own IdempotencyGuardTest (see testing-guide.md), since all four classes are
 * deliberate copies of each other.
 */
@ExtendWith(MockitoExtension.class)
class IdempotencyGuardTest {

    private static final String KEY_PREFIX = "merchantpayment:idem:";
