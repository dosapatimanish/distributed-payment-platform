package com.paymentplatform.wallet.observability;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.paymentplatform.wallet..*(..))"
            + " && !within(com.paymentplatform.wallet.observability..*)"
            + " && !within(com.paymentplatform.wallet.domain..*)"
            + " && !execution(* com.paymentplatform.wallet..*Application.*(..))")
